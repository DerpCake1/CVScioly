...
/*
Test on ESP32-wroom-32 use HWT101 sensor
...
static void ShowHelp(void)
{
  ...
  Serial.print("UART SEND:N\\r\\n   The return rate reduction to 500Hz.\r\n");
...
static void CmdProcess(void)
{
	switch(s_cCmd)
	{
		...
		case 'B':	if(WitSetUartBaud(WIT_BAUD_115200) != WIT_HAL_OK) Serial.print("\r\nSet Baud Error\r\n");
              ...
              {
                Serial2.begin(c_uiBaud[WIT_BAUD_115200], SERIAL_8N1, RXD2, TXD2);
		...
		case 'b':	if(WitSetUartBaud(WIT_BAUD_9600) != WIT_HAL_OK) Serial.print("\r\nSet Baud Error\r\n");
              ...
              {
                Serial2.begin(c_uiBaud[WIT_BAUD_9600], SERIAL_8N1, RXD2, TXD2); 
                Serial.print(" 9600 Baud rate modified successfully\r\n");
              }
			break;
		case 'M':	if(WitSetUartBaud(WIT_BAUD_230400) != WIT_HAL_OK) Serial.print("\r\nSet Baud Error\r\n");
              else 
              {
                Serial2.begin(c_uiBaud[WIT_BAUD_230400], SERIAL_8N1, RXD2, TXD2); 
                Serial.print(" WIT_BAUD_230400 Baud rate modified successfully\r\n");
              }
			break;
		case 'r': if(WitSetOutputRate(RRATE_1HZ) != WIT_HAL_OK)  Serial.print("\r\nSet Baud Error\r\n");
			        else Serial.print("\r\nSet Baud Success\r\n");
			break;
		case 'R':	if(WitStartIYAWCali() != WIT_HAL_OK) Serial.print("\r\nWitStartIYAWCali Error\r\n");
              else Serial.print("\r\nWitStartIYAWCali Success\r\n");
			  break;
		case 'N':	if(WitSetOutputRate(RRATE_ONCE) != WIT_HAL_OK) Serial.print("\r\nSet Baud Error\r\n");
    ...
    case 't':
        if (WitStartRKMODECali() != WIT_HAL_OK)
            printf("\r\nSart RKMODECali Error\r\n");
        else
            printf("\r\Start RKMODECali Success\r\n");
        break;
    case 'T':
        if (WitStopRKMODECali() != WIT_HAL_OK)
            printf("\r\nStop RKMODECali Error\r\n");
        else
            printf("\r\Stop RKMODECali Success\r\n");
        break;
    case 'S':
        if (WitSetAngleRange() != WIT_HAL_OK)
          printf("\r\nSetAngleRange Error\r\n");
        else
          printf("\r\nSetAngleRange Success\r\n");
        break;
		case 'h':	ShowHelp();
			break;
		default :break;
